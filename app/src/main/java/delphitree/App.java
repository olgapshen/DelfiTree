...
import delphitree.exceptions.NotADirException;
...
public class App
{
    ...
    public void run(String[] args)
    {
        if (args.length < 3) {
            ...
            System.out.println("  <sources> путь к файлам Delphi");
            ...
            String prefix = prefixParam.equals("-") ? "" : prefixParam;
            ...
            if (!filesDir.isDirectory()) {
                ...
                System.out.println(String.format("Префик      : %s", prefix));
                System.out.println(String.format("Модуль      : %s", unitParam));

                Forest nodes = new TreeParser(filesDir).makeTree(includeType, prefix, unitParam);
